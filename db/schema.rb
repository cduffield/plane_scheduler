...
ActiveRecord::Schema[8.1].define(version: 2026_06_03_032058) do
  ...
  create_table "event_payments", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.bigint "user_id", null: false
    t.index ["event_id", "user_id"], name: "index_event_payments_on_event_id_and_user_id", unique: true
    t.index ["event_id"], name: "index_event_payments_on_event_id"
    t.index ["pay_charge_id"], name: "index_event_payments_on_pay_charge_id"
  ...
  create_table "events", force: :cascade do |t|
    ...
    t.integer "status", default: 0, null: false
    t.decimal "tach_end", precision: 8, scale: 1
  ...
  create_table "maintenance_inspection_events", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.decimal "hobbs_time", precision: 8, scale: 1
    t.bigint "maintenance_inspection_id", null: false
    t.text "notes"
    t.datetime "performed_at", null: false
    t.decimal "tach_time", precision: 8, scale: 1
    t.datetime "updated_at", null: false
    t.index ["maintenance_inspection_id"], name: "idx_on_maintenance_inspection_id_bb46c54583"
  end

  create_table "maintenance_inspections", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.index ["airplane_id"], name: "index_maintenance_inspections_on_airplane_id"
  end
